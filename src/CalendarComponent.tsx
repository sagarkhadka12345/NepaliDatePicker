...
import { TDateStyle, TDefaultStyle } from "./types";
function CalendarComponent({
  handleDate,
  defaultStyle,
}: {
  handleDate: (date: TDateStyle) => void;
  ...
  const [isLanguageofMainDateNepali, setisLanguageOfMainDateNepali] =
    useState(false);
  ...
  const handleSelect = (
    ...
    handleDate(
      isNepali
        ? {
            bsDate: `${year}-${month}-${+e.currentTarget.value}`,
            adDate: nepaliDate
              .getEnglishDate(year, month, +e.currentTarget.value)
              .toISOString(),
          }
        : {
            adDate: DateTime.fromObject({
              year: year,
              month: month,
              day: +e.currentTarget.value,
            })
              ...
              .toISOString(),
            bsDate: `${
              nepaliDate.getNepaliDate(year, month, +e.currentTarget.value).year
            }- ${
              nepaliDate.getNepaliDate(year, month, +e.currentTarget.value)
                .month
            }-${
              nepaliDate.getNepaliDate(year, month, +e.currentTarget.value).day
            }`,
          }
    );
  ...
  const [, setSelectedDateInBS] = useState("");
  ...
  return (
    <div
      className="nepali-date-picker-flex nepali-date-picker-flex-col nepali-date-picker-ganepali-date-picker-p-2"
      style={defaultStyle ? defaultStyle.main : {}}
    >
      {isNepali ? (
        selected?.year && selected.month && selected.day ? (
          <input
            onClick={handleClick}
            type={isNepali ? "string" : "date"}
            style={defaultStyle ? defaultStyle.input : {}}
            readOnly
            placeholder="YYYY=MM-DD"
            value={`${selected?.year}-${selected?.month}-${selected?.day}`}
            className="nepali-date-picker-cursor-pointer  nepali-date-picker-outline-none nepali-date-picker-border-none"
          />
        ) : (
          <input
            onClick={handleClick}
      ...
      {isCalendarOpen && (
        <div
          className={`nepali-date-picker-overflow-hidden nepali-date-picker-w-max nepali-date-picker-h-max  `}
          ref={calendarRef}
          style={defaultStyle ? defaultStyle.calendarWrapper : {}}
        >
          <div
            ...
            style={defaultStyle ? defaultStyle.calendar : {}}
          >
            <div className=" nepali-date-picker-w-full nepali-date-picker-py-2 nepali-date-picker-flex nepali-date-picker-justify-between nepali-date-picker-items-center nepali-date-picker-rounded-sm nepali-date-picker-shadow-md">
              <div
                onClick={handleToggle}
                className="nepali-date-picker-cursor-pointer nepali-date-picker-flex-1 nepali-date-picker-flex nepali-date-picker-justify-center nepali-date-picker-items-start"
              >
                {isNepali ? "NP" : "EN"}
              </div>
              <div
                ...
                className="nepali-date-picker-cursor-pointer nepali-date-picker-flex-1 nepali-date-picker-flex nepali-date-picker-justify-center nepali-date-picker-items-start"
              >
                {isLanguageofMainDateNepali ? "Main-NP" : "Main-EN"}
              </div>
            </div>
            ...
            >
              ...
              <div
                ...
                style={defaultStyle ? defaultStyle.weekWrapper : {}}
              >
                {(isNepali
                  ...
                  <button
                    ...
                    key={item}
                    style={defaultStyle ? defaultStyle.weekday : {}}
                  >
                    {item}
                  </button>
                ))}
              ...
              {!isNepali ? (
                <>
                  <div
                    ...
                    style={defaultStyle ? defaultStyle.weekRow : {}}
                  >
                    {Array.from(Array(42)).map((_, index) => {
                      if (index >= firstDay && num < lastDay) {
                        ...
                        nepali-date-picker-border-none nepali-date-picker-outline-none hover:nepali-date-picker-border-none hover:nepali-date-picker-outline-none `
                            ...
                            style={defaultStyle ? defaultStyle.dayMain : {}}
                          >
                            <div
                              className={
                                (todaySelectedEN
                              ...
                              {isLanguageofMainDateNepali ? (
                                <>
                                  {num
                                    ...
                                    .join("")}
                                  <span className="nepali-date-picker-text-[.57rem] nepali-date-picker-text-gray-500 nepali-date-picker-font-extrabold nepali-date-picker-absolute nepali-date-picker-bottom-[.13rem] nepali-date-picker-right-[.3rem]">
                                    {
                ...
                nepali-date-picker-border-none nepali-date-picker-outline-none nepali-date-picker-flex nepali-date-picker-justify-center nepali-date-picker-items-center nepali-date-picker-p-2 nepali-date-picker-m-0 nepali-date-picker-rounded-none nepali-date-picker-text-gray-400"
                            value={num}
                            onClick={handleNextMonth}
                            style={defaultStyle ? defaultStyle.nextDayMain : {}}
                          >
                            {isLanguageofMainDateNepali ? (
                              <>
                                {greaterday
                                ...
                                <span
                                 ...
                                 nepali-date-picker-text-gray-300 nepali-date-picker-font-extrabold nepali-date-picker-absolute nepali-date-picker-bottom-[.13rem] nepali-date-picker-right-[.3rem]"
                                  style={
                                    defaultStyle ? defaultStyle.nextDaySub : {}
                                  }
                                >
                                  {
                                    nepaliDate.getNepaliDate(
                ...
                nepali-date-picker-border-none nepali-date-picker-outline-none nepali-date-picker-flex nepali-date-picker-justify-center nepali-date-picker-items-center nepali-date-picker-p-2 nepali-date-picker-m-0 nepali-date-picker-rounded-none nepali-date-picker-text-gray-400"
                            value={num}
                            onClick={handlePrevMonth}
                            style={defaultStyle ? defaultStyle.prevDayMain : {}}
                          >
                            {isLanguageofMainDateNepali ? (
                              <>
                                {(
                          ...
                          >
                            <div
                              className={
                                ...
                                " nepali-date-picker-flex-1  nepali-date-picker-text-base   nepali-date-picker-outline-none nepali-date-picker-flex  transition-all  nepali-date-picker-items-center nepali-date-picker-p-2 nepali-date-picker-m-0  nepali-date-picker-relative"
                              }
                              style={defaultStyle ? defaultStyle.dayMain : {}}
                            >
                              {isLanguageofMainDateNepali ? (
                                <>
                                    ...
                                    .join("")}
                                  {
                                    <span
                                      className="nepali-date-picker-text-[.57rem] 
                                     nepali-date-picker-font-extrabold nepali-date-picker-absolute nepali-date-picker-bottom-[.13rem] nepali-date-picker-right-[.3rem]"
                                      style={
                                        defaultStyle ? defaultStyle.daySub : {}
                                      }
                                    >
                                      {nepaliDate
                                ...
                                <>
                                  ...
                                  {
                                    <span
                                      className="nepali-date-picker-text-[.57rem] nepali-date-picker-text-gray-500
                                     nepali-date-picker-font-extrabold nepali-date-picker-absolute nepali-date-picker-bottom-[.13rem] nepali-date-picker-right-[.3rem]"
                                      style={
                                        defaultStyle ? defaultStyle.daySub : {}
                                      }
              ...
              {showNepaliMonth && (
                <div
                  ...
                  style={defaultStyle ? defaultStyle.monthBackground : {}}
                >
                  <div
                    ...
                    style={{
                      ...
                      ...(defaultStyle ? defaultStyle.monthWrapper : {}),
                    }}
                    ref={monthREf.ref}
                  >
                    {isNepali
                      ? nepaliDate.NEPALI_MONTH.map((item, index) =>
                          index + 1 == selected?.month ? (
                            <div
                              className="nepali-date-picker-flex-1 nepali-date-picker-text-md nepali-date-picker-py-[.1rem] hover:nepali-date-picker-text-lg hover:nepali-date-picker-py-1 nepali-date-picker-cursor-pointer nepali-date-picker-font-medium hover:nepali-date-picker-font-semibold"
                              key={item}
                              style={defaultStyle ? defaultStyle.month : {}}
                            >
                              {item}
                            </div>
                          ) : (
             ...
             nepali-date-picker-z-20"
                  style={defaultStyle ? defaultStyle.yearBackground : {}}
                >
                  {showNepaliYear && (
                    <div
                      ...
                      style={{
                        ...
                        ...(defaultStyle ? defaultStyle.yearWrapper : {}),
                      }}
                      ref={ref}
                    >
                      <div>
                          ...
                          ? Object.keys(nepaliDate.NEPALI_YEARS).map((item) =>
                              year === +item ? (
                                <div
                                  ...
                                  key={item}
                                  style={defaultStyle ? defaultStyle.year : {}}
                                  ref={scrollTo}
                                >
                                  {item}
                                </div>
                          ...
                          : Array.from(
                              ...
                              return year === +index + nepaliDate.START_EN ? (
                                <div
                                  ...
                                  ref={scrollTo}
                                  style={
                                    defaultStyle ? defaultStyle.yearActive : {}
                                  }
                                >
